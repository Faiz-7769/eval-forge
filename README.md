...
Before building a RAG system or any use of case of transformer model over any domain, Companies need to answer one question: **which model should I actually use?**
...
eval-forge/
├── notebooks/
│   ├── inference.ipynb        # model inference + GPU metrics
│   └── evaluation.ipynb       # DeepEval scoring
├── data/
